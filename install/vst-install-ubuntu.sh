...
software="apache2 apache2-utils apache2-suexec-custom bsdutils e2fsprogs
...
wget https://raw.githubusercontent.com/gabrielPav/vesta/master/install/ubuntu/nginx.init.txt -O /etc/init.d/nginx
