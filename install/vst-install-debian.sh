...
wget https://raw.githubusercontent.com/gabrielPav/vesta/master/install/debian/templates/web/nginx/default.tpl -O /usr/local/vesta/data/templates/web/nginx/default.tpl
wget https://raw.githubusercontent.com/gabrielPav/vesta/master/install/debian/templates/web/nginx/default.stpl -O /usr/local/vesta/data/templates/web/nginx/default.stpl
wget https://raw.githubusercontent.com/gabrielPav/vesta/master/install/debian/templates/web/nginx/caching.tpl -O /usr/local/vesta/data/templates/web/nginx/caching.tpl
wget https://raw.githubusercontent.com/gabrielPav/vesta/master/install/debian/templates/web/nginx/caching.stpl -O /usr/local/vesta/data/templates/web/nginx/caching.stpl
